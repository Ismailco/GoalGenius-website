...
export default function Header() {
	...
	return (
		<>
			<header className="border-b border-white/10 backdrop-blur-xl bg-gradient-to-r from-slate-900/90 to-black/80">
				<div className="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8">
					<div className="flex justify-between items-center">
						{/* Mobile Menu Button */}
						<button onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)} className="sm:hidden p-2 rounded-xl bg-white/5 hover:bg-white/10 transition-colors">
			...
			{/* Mobile Menu Overlay */}
			{isMobileMenuOpen && <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[998] sm:hidden" onClick={() => setIsMobileMenuOpen(false)} />}
