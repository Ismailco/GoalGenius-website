				...
				{formState.submitted ? (
					<AnimatedSection initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }} className="max-w-2xl mx-auto bg-white/5 backdrop-blur-lg rounded-3xl p-8 border border-white/10 text-center">
						...
						<div className="flex flex-col sm:flex-row gap-4 justify-center">
							...
							<Link href="https://app.goalgenius.online" className="inline-flex items-center px-6 py-3 font-medium rounded-full text-white bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 transform hover:scale-105 transition-all duration-200">
								Try the Demo
