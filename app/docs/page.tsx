    ...
    content: [
      {
        ...
        type: 'list',
        items: [
          '1. Visit app.goalgenius.online and click "Sign Up"',
          '2. Choose your authentication method (Google, GitHub, or Email)',
      ...
      },
      {
        ...
        type: 'list',
        items: [
          '1. Navigate to the Goals dashboard',
          '2. Click "Create Goal" to start a new goal',
          '3. Set goal title, description, and deadline',
          '4. Add milestones and success criteria',
      ...
      },
      {
        ...
        type: 'list',
        items: [
          '1. Access the Todo section',
          '2. Create todos with priorities and deadlines',
          '3. Group todos by projects or goals',
          '4. Set reminders and notifications',
          '5. Track completion status',
          '6. View todo analytics'
        ]
      },
      {
        title: 'Milestones',
        ...
        type: 'list',
        items: [
          '1. Open a goal and click "Add Milestone"',
          '2. Set milestone title and target date',
          '3. Define success criteria',
          '4. Add subtasks if needed',
          '5. Track milestone progress',
          '6. Celebrate milestone completion'
        ]
      },
      {
        title: 'Check-ins',
        ...
        items: [
          ...
          '2. Record progress updates',
          '3. Add reflection notes',
          '4. Update goal status',
          '5. Identify blockers or challenges',
          '6. Plan next actions'
        ]
      },
      {
        ...
        items: [
          ...
          '2. Organize notes with tags and categories',
          '3. Link notes to goals or milestones',
          '4. Add attachments and references',
      ...
      },
      {
        ...
        type: 'list',
        items: [
          '1. View goal completion rates',
          '2. Track milestone progress',
          '3. Analyze check-in patterns',
          '4. Monitor todo completion',
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        type: 'list',
        items: [
          'GET /api/goals/:id/checkins - List goal check-ins',
      ...
      },
      {
        ...
        type: 'list',
        items: [
          'GET /api/analytics/goals - Goal completion statistics',
          'GET /api/analytics/milestones - Milestone progress',
          'GET /api/analytics/todos - Todo completion rates',
          'GET /api/analytics/checkins - Check-in patterns',
...
pnpm dev`
      ...
      },
      {
        ...
        items: [
          ...
          '4. Ensure tests pass and add new ones if needed',
				...
				<div className="container mx-auto px-4">
					<AnimatedSection initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-3xl p-12 border border-white/10 text-center">
						...
						<div className="flex flex-wrap gap-4 justify-center">
							...
							<a href="https://github.com/ismailco/goalgenius/issues" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-8 py-3 text-lg font-medium rounded-full text-white bg-white/10 hover:bg-white/20 transform hover:scale-105 transition-all duration-200">
								GitHub Issues
								<svg className="w-5 h-5 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
